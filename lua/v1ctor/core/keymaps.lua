...
local vnoremap = require("v1ctor.core.keymaps-utils").vnoremap
local inoremap = require("v1ctor.core.keymaps-utils").inoremap
local tnoremap = require("v1ctor.core.keymaps-utils").tnoremap
local xnoremap = require("v1ctor.core.keymaps-utils").xnoremap
-- local utils = require("v1ctor.core.utils")
